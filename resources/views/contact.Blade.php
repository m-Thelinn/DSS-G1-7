    ...
    <div class="row justify-content-center">
        ...
        <p class="contact-subtitle mb-5">Sobre nosotros</p>
            <p>Somos un equipo de cobertura de Esports de Valorant apasionado por proporcionar información precisa 
                ...
                los últimos acontecimientos en el mundo de los Esports de Valorant.</p>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 text">
            <div>
                ...
                <p class="options-title">PRESIDENTE</p>
                <p>MIGUEL RODRÍGUEZ SÁNCHEZ</p>
            ...
            <div>
                ...
                <p class="options-title">VICEPRESIDENTE</p>
                <p>FRANCISCO FERNÁNDEZ RUIZ</p>
            ...
            <div>
                ...
                <p class="options-title">ANALISTA DE DATOS</p>
                <p>DEMIAN CALVO RODRÍGUEZ</p>
            ...
            <div>
                ...
                <p class="options-title">GERENTE DE MARKETING</p>
                <p>JULIO CÉSAR BASTIDAS SÁNCHEZ</p>
